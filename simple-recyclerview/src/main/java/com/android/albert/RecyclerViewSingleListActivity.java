...
import com.android.albert.adapter.SingleAdapter;
 ...
 * @brief 单列表样式
 */
public class RecyclerViewSingleListActivity extends BaseSimpleActivity implements DataLoadListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new SingleAdapter(mContext);
